    ...
    return (
        <div>
            ...
            <section style={{
                ...
                {[
                    { label: "MOVIES LOGGED", value: "âˆž" },
                    { label: "TV EPISODES", value: "âˆž" },
                    { label: "SONGS TRACKED", value: "âˆž" },
                    { label: "YOUTUBE VIDEOS", value: "âˆž" },
                ].map((stat) => (
            ...
            <footer style={{
                ...
                <p style={{ color: "#AAAAAA", textTransform: "uppercase", fontWeight: 600, letterSpacing: "0.1em" }}>Â© 2026 MOSIAC â€” The Official Tracker</p>
            </footer>
        </div>
    );
}
