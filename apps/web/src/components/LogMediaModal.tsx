...
import { X, Star, Calendar, Tag, Heart, Loader2 } from 'lucide-react'
...
export default function LogMediaModal({ media, onClose, onSuccess }: Props) {
        ...
        <div style={{
            ...
            <div className="card animate-fade-in" style={{
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                    ...
                    >
                        {loading ? <><Loader2 size={16} style={{ animation: 'spin 1s linear infinite' }} /> Saving…</> : 'Save to Diary'}
                    </button>
                </form>
